...
Baksnapper is a script for backing up snapshots using btrfs send and receive.  It currently support backing up snapshots created by [snapper](http://snapper.io/) or [DeNotebak](https://sr.ht/~plattfot/DeNotebak/).
